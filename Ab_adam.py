...
from Ac_adam_loops import inst_optimization
...
def apply_instance_optimization(
        ...
        save_directory: Path = Path("./CVIS/41c_adam"),
    ...
    gen = tqdm(get_paths(data_json=data_json, split_val=split_val, disp_root=Path("")))
