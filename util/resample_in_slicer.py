...
import glob
rootDir='E:/mike/repos/optimization-based-registration/datasets/NLST/imagesTr'
resampledDir='E:/mike/repos/optimization-based-registration/datasets/NLST/imagesTr/Resampled'
