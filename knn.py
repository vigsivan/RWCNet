...
def swig_ptr_from_Tensor(x):
    ...
    if x.dtype == torch.int64:
        ...
        return faiss.cast_integer_to_uint8_ptr(x.storage().data_ptr() + x.storage_offset() * 8)
...
def knn_faiss_raw(fmap1, fmap2, k):
    ...
    if b == 1:
        ...
        dist, indx = search_raw_array_pytorch(res, fmap2, fmap1, k, metric=faiss.METRIC_L2)
